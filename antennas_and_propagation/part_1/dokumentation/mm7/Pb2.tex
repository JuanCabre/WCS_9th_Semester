...
We implemented the designed antenna from mm6 shown in \figref{fig:3_element_yagi-uda_geometry}. The simulation parameters for this simulation is shown in \tref{tab:antenna_param_CSTtime} and the design setup from CST is shown in \figref{fig:3_element_yagi-uda_geometry}.
