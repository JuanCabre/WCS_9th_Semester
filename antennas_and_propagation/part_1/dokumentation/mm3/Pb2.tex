...
\begin{flalign}
&& G_e &= \int_0^{2\pi} \int_0^\pi \frac{XPR}{1+XPR} G_\theta P_\theta \sin{\theta} d\theta d\phi &\\
&& &= \int_0^{2\pi} \int_0^\pi 1.5 \sin^2{\theta} \delta(\theta-\SI{90}{\degree})  d\theta d\phi &\\
&& &= 2\pi \int_0^\pi 1.5 \sin^2{\theta} \delta(\theta-\SI{90}{\degree})  d\theta &\\
